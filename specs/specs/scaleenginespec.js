		...
		describe("when given a query", function() {
			it("returns true or false", function() {
				const testData = {
                    ...
                    'C phrygian #6': true,
                    'C dorian b2': true,
                    'C lydian augmented': true,
                    'C lydian #5': true,
                    'C overtone': true,
                    'C acoustic': true,
                    'C lydian dominant': true,
                    'C lydian b7': true,
                    'C mixolydian b6': true,
                    'C mixolydian b13': true,
                    'C aeolian dominant': true,
                    'C aeolian major': true,
                    'C melodic major': true,
                    'C locrian #2': true,
                    'C half diminished': true,
                    'C super locrian': true,
                    'C altered': true,
                    'C altered dominant': true,
                    'C pomeroy': true,
                    'C ravel': true,
                    'C diminished whole tone': true,
                    'C dominant whole tone': true,
                    'C locrian b4': true,
                    ...
                    'C dorian #4': true,
                    'C dorian #11': true,
                    'C phrygian major': true,
                    'C phrygian dominant': true,
                    'C lydian #2': true,
                    'C alt dominant': true,
