class ChordEngine {
  ...
  getNotesFromSymbol(symbol) {
    ...
    if (symbol.includes('aug')) {
      fifthIndex = rootIndex + 8;
    }

    let sixthIndex = rootIndex;
    if (symbol.includes('6')) {
      sixthIndex = rootIndex + 9;
    }
    ...
    if (symbol.includes('9')) {
      seventhIndex = rootIndex + 10;
    }
    if (symbol.includes('11')) {
      seventhIndex = rootIndex + 10;
    }
    if (symbol.includes('13')) {
      seventhIndex = rootIndex + 10;
    }
    if (symbol.includes('M7')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('M9')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('M11')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('M13')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('maj7')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('maj9')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('maj11')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('maj13')) {
      seventhIndex = rootIndex + 11;
    }
    if (symbol.includes('dim') && seventhIndex == rootIndex + 10) {
      seventhIndex--;
    }
